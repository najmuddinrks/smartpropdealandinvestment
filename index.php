...
<head>
    ...
    <title>Smart Property Deals And Investment</title>
...
<body>
   <header>
    ...
    <div class="top-header-section d-xl-block d-none"> 
        <div class="container"> 
       <div class="row wrapper">
           <!--******************* top-header-left section is going to be started ******************* -->
          <div class="top-header-left d-xl-block d-none"> 
            <div class="logo">
              <a href="javasript:void"><img src="IMAGES/logo.png" alt="logo"></a> 
            </div>
           ...
           <div class="dropBox" id="dropdown2">
            ...
            <div class="global sub-pattern drop-img">
              <img src="IMAGES/international-svg.webp" alt="global">
              <span>International</span>
              <div class="global-formation">
                <ul>
                  <li> <img src="IMAGES/flag/nri.webp" alt="international"><a href="javascript:void">NRI</a></li>
                  <li> <img src="IMAGES/flag/usa.webp" alt="usa"><a href="javascript:void">USA</a></li>
                  <li> <img src="IMAGES/flag/dubai.webp" alt="dubai"><a href="javascript:void">UAE</a></li>
                  <li> <img src="IMAGES/flag/canada.webp" alt="canada"><a href="javascript:void">Canada</a></li>
                  <li> <img src="IMAGES/flag/australia.webp" alt="australia"><a href="javascript:void">Australia</a></li>
                  <li> <img src="IMAGES/flag/singapore.webp" alt="singapore"><a href="javascript:void">Singapore</a></li>
                  <li> <img src="IMAGES/flag/uk.webp" alt="uk"><a href="javascript:void">London</a></li>
                </ul> 
              </div>
            </div>       
           </div>   
  ...
  <button type="button" class="close close-edit" data-dismiss="modal" >&times;</button>
    ...
    <button type="button" class="close close-edit2" data-dismiss="modal" >&times;</button>
      ...
      <div class="unstoppable">
        <!-- <div class="button btn-setting" data-target="#mymodal1" data-toggle="modal">
          post property
        ...
        <div class="row wrapper"> 
           <div class="menset"> 
            <ul class="setmenu menu-main" id="setMenuList">
              <li class="resp-activity d-xl-none">
                <a href="javascript:void" class="menu-click">
                  my activity
              ...
              <!--******************* sell section is going to be started ******************* --> 
               ...
               <div class="mega-setting2 d-none">
                <i class="fas fa-arrow-left"></i>
                <span>sell</span>
              </div>
                <div class="sub-menu mega-menu">
              ...
              <!--******************* home rent section is going to be started ******************* -->
               ...
               <div class=" d-xl-none img-top-left-head" id="img-head">
                <img src="IMAGES/top-head-resp.jpg" alt="main-head">
              </div>
              <div class="d-xl-none logo" id="temp-head">
                <a href="javasript:void"><img src="IMAGES/logo.png" alt="logo" style="background-color: red;"></a>
              </div>   
     ...
     <div class="megastar  d-xl-none d-block"> 
      ...
      <li class="mega__item light-color w-100">
        <a class="mega__link" href="#">
            ...
            <ul class="mega__sub">
              <li class="mega__item">
                ...
                <div class="center__div "id="panel4">
                  ...
                  <h4 class="plusminus">budget friendly PC<sub>G</sub></h4>
                  <ul>
          ...
          <li class="mega__item">
            <a class="mega__link" href="#">home shifting <span class="badge-wrapper wrapped-badge">flat 20% off</span></a>
          </li>
          <li class="mega__item">
...
<a class="mega__link" href="#">smart advice<span class="badge-wrapper badge-wrap">new</span><i class="fas fa-angle-right"></i></a>
          ...
          <li class="mega__item">
            <a class="mega__link" href="#">
              <div class="d-xl-none img-top-left-head" id="img-head">
                <img src="IMAGES/main-head2.png" alt="main-head" class="img-fluid">
              </div>
            </a>
          </li>
          <li class="mega__item">
            <a class="mega__link" href="#">
              <div class="d-xl-none logo-section" id="temp-head">
                <a href="javasript:void"><img src="IMAGES/logo.png" alt="logo" style="background-color: red;" class="img-fluid"></a>
              </div>
            </a>
          </li>
          </ul>  
   ...
   <main>
        ...
        <div class="container">
          <div class="wrapper row">
            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 d-block margin-bottom">
             <div class="explore">
              <span class="display-1">explore</span>
            ...
            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 d-block margin-bottom">
              <div class="card">
                <div class="card-body">
                  ...
                  <button class="button2 btn-padding">contact owner</button>
                  </div>
                </div>
              </div> 
              </div>
     ...
     <section class="exclusive__owner__properties">
      <div class="container">
        <h2 class="h2-set">Exclusive Owner Properties in Mumbai</h2>
        <div class="wrapper row slider9">
          <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 d-block margin-bottom">
            <div class="card">
              <img src="./IMAGES/card/exclusive-owner/1.jpg" alt="exclusive">
              <div class="card-body">
                <div class="card-header">
                  <p>4 BHK Flat</p>
                </div>  
            ...
            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 d-block margin-bottom">
              <div class="card">
              <img src="./IMAGES/card/exclusive-owner/2.jpg" alt="exclusive">
                <div class="card-body">
                  <div class="card-header">
                    <p>3 BHK Flat</p>
                  </div>  
              ...
              <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 d-block margin-bottom">
                <div class="card">
              <img src="./IMAGES/card/exclusive-owner/3.jpg" alt="exclusive">
                  <div class="card-body">
                    <div class="card-header">
                      <p>2 BHK Flat</p>
                    </div> 
                ...
                <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 d-block margin-bottom">
                  <div class="card">
              <img src="./IMAGES/card/exclusive-owner/4.jpg" alt="exclusive">
                    <div class="card-body">
                      <div class="card-header">
                        <p>2 BHK Flat</p>
                      </div>  
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 d-block margin-bottom">
                    <div class="card">
                 <img src="./IMAGES/card/exclusive-owner/5.jpg" alt="exclusive">
                      <div class="card-body">
                        <div class="card-header">
                          <p>1 BHK Flat</p>
                        </div> 
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 d-block margin-bottom">
                      <div class="card">
              <img src="./IMAGES/card/exclusive-owner/6.jpg" alt="exclusive">
                        <div class="card-body">
                          <div class="card-header">
                            <p>5 BHK Flat</p>
                          </div> 
                      ...
                      <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 d-block margin-bottom">
                        <div class="card">
                 <img src="./IMAGES/card/exclusive-owner/7.jpg" alt="exclusive">
                          <div class="card-body">
                            <div class="card-header">
                              <p>1 BHK Flat</p>
                            </div>  
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 d-block margin-bottom">
                          <div class="card">
              <img src="./IMAGES/card/exclusive-owner/8.jpg" alt="exclusive">
                            <div class="card-body">
                              <div class="card-header">
                                <p>2 BHK Flat</p>
                              </div> 
                          ...
                          <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 d-block margin-bottom">
                            <div class="card">
              <img src="./IMAGES/card/exclusive-owner/9.jpg" alt="exclusive">
                              <div class="card-body">
                                <div class="card-header">
                                  <p>2 BHK Flat</p>
                                </div> 
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 d-block margin-bottom">
                              <div class="card">
              <img src="./IMAGES/card/exclusive-owner/10.jpg" alt="exclusive">
                                <div class="card-body">
                                  <div class="card-header">
                                    <p>2 BHK Flat</p>
                                  </div> 
    ...
    <section class="real__estate__guide">
      <div class="container">
        <h2 class="h2-set">Your Real Estate Guide</h2>
        <div class="wrapper row">
                ...
                <div class="card-content">
                  <div class="slider8">
                    <div class="card-seperated">
                      <img class="card-img-top card-img-margin img-fluid" src="IMAGES/card/fresh-prop/andher-east-1-retouching.jpg" alt="Card image-fresh">
                      <p>Locality Review -</p>
        ...
        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 d-block margin-bottom">
          <div class="card card-top-border">
            <div class="card-body">
              ...
              <div class="card-content">
                <ul>
                  <li><i class="fas fa-file pr-xl-3 margin-right"></i><a href="javascript:void">14 Cheapest Platforms To Pay Rent With Credit Card</a></li>
                  <li><i class="fas fa-file pr-xl-3 margin-right"></i><a href="javascript:void">Sale Deed: Meaning, Format, and Components of a Sale Deed</a></li>
                  <li><i class="fas fa-file pr-xl-3 margin-right"></i><a href="javascript:void">Ready Reckoner Rate - What Does it Mean and How to Calculate It?</a></li>
                  <li><i class="fas fa-circle-play pr-xl-3 margin-right"></i><a href="javascript:void">Stamp Duty and Registration Charges in Maharashtra 2023</a></li>
                  <li><i class="fas fa-circle-play pr-xl-3 margin-right"></i><a href="javascript:void">Most Posh Areas in Mumbai (Top 12 Most Expensive Areas)</a></li>
                </ul>
              </div>
              <div class="card-footer">
                <ul class="mb-0">
            ...
            <div class="card-body">
              ...
              <div class="card-content">
                ...
                <div class="video__part">
                  <img src="./IMAGES/card/fresh-prop/retouching-card-5.jpg" class="card-img-margin video__sec-img ">
                </div>
              ...
              <div class="card__block">
                <div class="article__part border-none">
                  <img src="./IMAGES/card/fresh-prop/deed" class="card-img-margin border-tradius-none">
                </div>
                <div class="video__text">
                  <p>Sale Deed: Meaning, Format, and Components of a Sale Deed</p>
                  <ul>
               ...
               <div class="video__sec">
                ...
                <div class="video__Sec__right__Text">
                <p>Inheritance Laws In India - All You to Know</p>
                  <ul>
                  <li><a href="javasript:void">watch video<i class="fas fa-arrow-right pl-lg-2"></i></a></li>
                </ul>
              ...
              <!-- <div class="article__part">
                <div class="article__doc">
                  <img src="./IMAGES/card/fresh-prop/retouching-card-5.jpg" class="video__sec-img img-fluid">
                  <p><strong>Sale Deed: Meaning, Format, and Components of a Sale Deed</strong></p>
                  <ul class="mb-0">
                    <li><a href="javasript:void">read article<i class="fas fa-arrow-right pl-lg-2"></i></a></li>
                  </ul>
                </div>
                </div> -->
              </div>
    ...
    <section class="fresh__prop">
      <div class="container">
       ...
       <li class="d-xl-block d-none"><a href="javasript:void" class="pr-lg-2">see all properties <i class="fas fa-arrow-right"></i></a></li></ul>
        <div class="wrapper row slider7">
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/fresh-prop/andher-east-1-retouching.jpg" alt="Card image-fresh">
              <div class="card-body">
                <div class="card-header">
                  <p class="d-flex justify-content-between align-items-center">1 BHK Flat<i class="fa-solid fa-house"></i></p>
                </div>  
                <div class="card-content">
                  <h2 class="m-lg-0"><strong><span>&#8377;33,000</span><span class="pl-lg-2">|</span><span class="pl-lg-2">&#8377;650 sqft.</span></strong></h2>
       ...
       <button type="button" class="btn button2 btn-padding" data-toggle="modal" data-target="#exampleModalCentered">Contact Owner</button>
   <button type="button" class="button btn-setting" data-target="#mymodal11" data-toggle="modal">
                login
              </button>
               <div class="modal fade" id="mymodal11">
    ...
    <button type="button" class="close close-edit2" data-dismiss="modal" >&times;</button>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/fresh-prop/andher-east-2-retouching.jpg" alt="Card image-fresh">
              <div class="card-body">
                <div class="card-header">
                    <p class="d-flex justify-content-between align-items-center">1 BHK Flat<i class="fa-solid fa-house"></i></p>
                </div>
                <div class="card-content">
                  <h2 class="m-lg-0"><strong><span>&#8377;45,500</span><span class="pl-lg-2">|</span><span class="pl-lg-2">&#8377;665 sqft.</span></strong></h2>
                  <p>andheri east, mumbai</p>
                  <p>ready to move</p>
                </div>
                <div class="card-footer">
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/fresh-prop/retouching-card-andher-east-3.jpg" alt="Card image-fresh">
              <div class="card-body">
                <div class="card-header">
                  <p class="d-flex justify-content-between align-items-center">1 BHK Flat<i class="fa-solid fa-house"></i></p>
                </div>
                <div class="card-content">
                  <h2 class="m-lg-0"><strong><span>&#8377;40,500</span><span class="pl-lg-2">|</span><span class="pl-lg-2">&#8377;625 sqft.</span></strong></h2>
                  <p>andheri east, mumbai</p>
                  <p>ready to move</p>
                </div>
                <div class="card-footer">
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/fresh-prop/vilke-parle--retouching.jpg" alt="Card image-fresh">
              <div class="card-body">
                <div class="card-header">
                  <p class="d-flex justify-content-between align-items-center">2 BHK Flat<i class="fa-solid fa-house"></i></p>
                </div>
                <div class="card-content">
                  <h2 class="m-lg-0"><strong><span>&#8377;15,000</span><span class="pl-lg-2">|</span><span class="pl-lg-2">&#8377;1000 sqft.</span></strong></h2>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/fresh-prop/chembur-retouch.jpg" alt="Card image-fresh">
              <div class="card-body">
                <div class="card-header">
                  <p class="d-flex justify-content-between align-items-center">2 BHK Flat<i class="fa-solid fa-house"></i></p>
                </div>        
                <div class="card-content">
                  <h2 class="m-lg-0"><strong><span>&#8377;61,000</span><span class="pl-lg-2">|</span><span class="pl-lg-2">&#8377;850 sqft.</span></strong></h2>
                  <p> chembur , mumbai</p>
                  <p>ready to move</p>
                </div>
                <div class="card-footer">
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/fresh-prop/retouching-card-oshiwara.jpg" alt="Card image-fresh">
              <div class="card-body">
                <div class="card-header">
                  <p class="d-flex justify-content-between align-items-center">2 BHK Flat<i class="fa-solid fa-house"></i></p>
                </div>           
                <div class="card-content">
                  <h2 class="m-lg-0"><strong><span>&#8377;75,000</span><span class="pl-lg-2">|</span><span class="pl-lg-2">&#8377;1100 sqft.</span></strong></h2>
                  <p>oshiwara, mumbai</p>
                  <p>ready to move</p>
                </div>
                <div class="card-footer">
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/fresh-prop/retouching-card-naigaon.jpg" alt="Card image-fresh">
              <div class="card-body">
                <div class="card-header">
                  <p class="d-flex justify-content-between align-items-center">1 BHK Flat<i class="fa-solid fa-house"></i></p>
                </div>
                <div class="card-content">
                  <h2 class="m-lg-0"><strong><span>&#8377;12,000</span><span class="pl-lg-2">|</span><span class="pl-lg-2">&#8377;625 sqft.</span></strong></h2>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/fresh-prop/kannamwar-nagar-retouch.jpg" alt="Card image-fresh">
              <div class="card-body">
                <div class="card-header">
                  <p class="d-flex justify-content-between align-items-center">1 BHK Flat<i class="fa-solid fa-house"></i></p>
                </div>
                <div class="card-content">
                  <h2 class="m-lg-0"><strong><span>&#8377;17,500</span><span class="pl-lg-2">|</span><span class="pl-lg-2">&#8377;250 sqft.</span></strong></h2>
    ...
    <section class="trending__societies">
      <div class="container">
        ...
        <div class="wrapper row slider6">
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/trending-society/forestvile.jpg" alt="Card image-trend">
              <div class="card-body">
                <div class="card-header">
                ...
                <div class="card-content">
                  ...
                  <p><span class="pr-lg-2">3 BHK, 3 BHK+Studio</span>|<span class="pl-lg-2">18 Acres</span></p>
                </div>
                <div class="card-footer">
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/trending-society/kalpatru-magnus.jpg" alt="Card image-trend">
              <div class="card-body">
                <div class="card-header">
                ...
                <div class="card-content">
                  ...
                  <p><span class="pr-lg-2">2BHK, 3BHK, 4.5BHK</span>|<span class="pl-lg-2">781 to 1800 sqft. 
                  </span></p>
                </div>
                <div class="card-footer">
                  <p class="card-title card-footer-block">Key Amenities:
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/trending-society/goregaon.jpg" alt="Card image-trend">
              <div class="card-body">
                <div class="card-header">
                ...
                <div class="card-content">
                  ...
                  <p><span class="pr-lg-2">2 BHK, 3 BHK, 4 BHK</span>|<span class="pl-lg-2">4 acres</span></p>
                </div>
                <div class="card-footer">
                  <p class="card-title card-footer-block">Key Amenities:
                    <i class="fa-solid fa-credit-card mr-2"></i>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/trending-society/lokhandwala.jpg" alt="Card image-trend">
              <div class="card-body">
                <div class="card-header">
                ...
                <div class="card-content">
                  ...
                  <p><span class="pr-lg-2">3,4 BHK Flats</span>|<span class="pl-lg-2">
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/trending-society/kandivali.jpg" alt="Card image-trend">
              <div class="card-body">
                <div class="card-header">
                ...
                <div class="card-content">
                  ...
                  <p><span class="pr-lg-2"> 2BHK, 3BHK Flat</span>|<span class="pl-lg-2">740 -  1006 sqft.</span></p>
                </div>
                <div class="card-footer">
                  <p class="card-title card-footer-block">Key Amenities:
                    <i class="fa-solid fa-credit-card mr-2"></i>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/trending-society/kanjumarg.jpg" alt="Card image-trend">
              <div class="card-body">
                <div class="card-header">
                ...
                <div class="card-content">
                  ...
                  <p><span class="pr-lg-2">1,2,3,4 BHK Flat</span>|<span class="pl-lg-2">353
                    - 676 sqft 
                  </span></p>
                </div>
                <div class="card-footer">
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/trending-society/jvlr.jpg" alt="Card image-trend">
              <div class="card-body">
                <div class="card-header">
                ...
                <div class="card-content">
                  ...
                  <p><span class="pr-lg-2">1 BHK,2 BHK</span>|<span class="pl-lg-2">439 - 709sqft.</span></p>
                </div>
                <div class="card-footer">
                  <p class="card-title card-footer-block">Key Amenities:
                    <i class="fa-solid fa-credit-card mr-2"></i>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/trending-society/ANDHERI-EAST.jpg" alt="Card image-trend">
              <div class="card-body">
                <div class="card-header">
                ...
                <div class="card-content">
                  ...
                  <p><span class="pr-lg-2">3,4,5,6 BHK Flat</span>|<span class="pl-lg-2">
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/trending-society/powai.jpg" alt="Card image-trend">
              <div class="card-body">
                <div class="card-header">
                ...
                <div class="card-content">
                  ...
                  <p><span class="pr-lg-2">1,2,3,4 BHK Flat</span>|<span class="pl-lg-2">
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="IMAGES/card/trending-society/eternia.jpg" alt="Card image-trend">
              <div class="card-body">
                <div class="card-header">
                ...
                <div class="card-content">
                  ...
                  <p><span class="pr-lg-2">3,4 BHK Flat</span>|<span class="pl-lg-2">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-block m-auto">
              <div class="jumbo__box">
                <div class="jumbo__box__left">
                  ...
                  <h5>List it on <span title="Smartdeal & Investment" data-toggle="tooltip" aria-label="Smartdeal & Investment">smartdeal & investment</span> to get genuine leads</h5>
                </div>
    ...
    <!-- <form action="javascript:void(0)" method="" onsubmit="return validation()" class="form-setting">
        ...
        <div class="form-group">
            ...
            <input type="text" name="pass" id="pass" class="form-control form-focus control-majno" autocomplete="off" placeholder="Please Enter the Correct Passowrd">
            <span id="Password" class="text-danger font-weight-bold"></span>
        </div>

        <div class="form-group">
            <label for="conpass">Confirm Password:</label>
            <input type="text" name="conpass" id="conpass" class="form-control form-focus control-majno" autocomplete="off" placeholder="Please Re Enter the Passowrd Once Again">
        ...
        <div class="form-group">
            ...
            <input type="text" name="email" id="email" class="form-control form-focus control-majno" autocomplete="off" placeholder="Type Mail Here..">
    ...
    <form action="index_info.php" method="post" onsubmit="return validation()" class="form-setting">
            <div class="form-group">
            <laelb for="user">Username:</laelb>
            <input type="text" name="username" id="user" class="form-control form-focus control-majno" autocomplete="off" placeholder="Please Type Your Name Here..">
            <span id="username" class="text-danger font-weight-bold"></span>
        </div>

        <div class="form-group">
            <label for="pass">Password:</label>
            <input type="text" name="password" id="pass" class="form-control form-focus control-majno" autocomplete="off" placeholder="Please Enter the Correct Passowrd">
            <span id="Password" class="text-danger font-weight-bold"></span>
        </div>

        <div class="form-group">
            <label for="conpass">Confirm Password:</label>
            <input type="text" name="confirm_password" id="conpass" class="form-control form-focus control-majno" autocomplete="off" placeholder="Please Re Enter the Passowrd Once Again">
            <span id="Confirm" class="text-danger font-weight-bold"></span>
        </div>
        ...
        <div class="form-group">
          <label for="textarea">Message:</label/abel>
          <textarea name="message" id="textarea" cols="105" rows="4" class="form-control form-focus control-majno" autocomplete="off"Type Mesaage Here...></textarea>

          <span id="textareamsg" class="text-danger font-weight-bold"></span>
      </div>
            <input type="submit" id="submit" value="submit" class="btn btn-outline-success text-uppercase"autocomplete="off">
   ...
   <footer>
      ...
      <div class="container">
        <div class="wrapper">
          ...
          <div class="footer-left-section">
            <div class="read-section">
              <h3>About Smartpropdeal</h3>
            <p class="visible-content">Smartpropdeal is a full stack service provider for all real estate needs...<span class="invisible-content"> with 15+ services including home loans, pay rent, packers and movers, legal assistance, property valuation, and expert advice. As the largest platform for buyers and sellers of property to connect in a transparent manner, Smartpropdeal has an active base of over 15 lakh property listings.</span>
              <a href="javascript:void(0)" id="btn">read more..</a>
            </p>
          </div>
          ...
          <div class="social-media">
            <div class="google-appstore">
              <div class="playstore"><img src="./IMAGES/ICON/playstore.png" class="img-fluid"></div>
              <div class="appstore"><img src="./IMAGES/ICON/appstore.png" class="img-fluid"></div>
            </div>
            <div class="social-media-links">
              <ul>
                ...
                <li><a href="https://in.linkedin.com/" target="_blank"></a></li>
    ...
    <div class="read-bottom-footer">
      <div class="container">
        <div class="wrapper">
          <div class="read-section">
          <p class="visible-content">Disclaimer: Magicbricks Realty Services Limited is only an intermediary offering its platform to advertise properties of Seller for a Customer/Buyer/User coming on its Website and is not and cannot be a party to or privy to or control in any manner any transactions between the Seller and the Customer/Buyer/User. All the offers and discounts on this Website have been extended by<span class="invisible-content">various Builder(s)/Developer(s) who have advertised their products. Magicbricks is only communicating the offers and not selling or rendering any of those products or services. It neither warrants nor is it making any representations with respect to offer(s) made on the site. Magicbricks Realty Services Limited shall neither be responsible nor liable to mediate or resolve any disputes or disagreements between the Customer/Buyer/User and the Seller and both Seller and Customer/Buyer/User shall settle all such disputes without involving Magicbricks Realty Services Limited in any manner.</span>
            <a href="javascript:void(0)" id="btn">read more..</a>
          </p>
        </div>
        </div>
    ...
    <div class="last-footer">
      <div class="container">
        <p>All trademarks, logos and names are properties of their respective owners. All &reg; Rights Reserved. &copy; Copyright 2023 Smartpropdeal and Investment Private Limited.</p>
      </div>
    </div>
   </footer>
</body>
